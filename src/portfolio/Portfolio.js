...
function Portfolio() {
    ...
    return (
        <div className='grid md:grid-cols-4 grid-cols-2 md:gap-10 md:mx-20 gap-4 mx-4 my-10'>
            ...
            <Link className='relative col-span-2' to="/dot_mesh">
                <img className='hover:opacity-80 object-cover w-full aspect-[3/2]' src={process.env.PUBLIC_URL + '/img/00_header.jpg'} alt='Palm Lace Campaign'/>
                <h4 className='text-white absolute hover:bg-black/25 duration-200 hover:opacity-100 opacity-0 inset-0 flex justify-center items-center md:text-xl'> Dot Mesh Campaign for Lively </h4>
            </Link>
            <Link className='inactive relative col-span-2' to="/apparel">
            ...
            <Link className='inactive relative col-span-2' to="/styling">
